...
<!--==============================================================================================================-->
        <div class="banner-container">
            <div class="content-container2 alignment">
                <h1>NETMATERS</h1>
...
<!--==============================================================================================================-->
        <div class="underline-b alignment">
                <h1 style="color:black;font-size: x-large;">Latest</h1>
                <hr style="color:black;width:5em;">
        </div>

        <div class="latest-container">
        <div class="alignment" style="display:flex;justify-content: space-around;">
            <?php 
            ...
            $sql = "SELECT id, title, description, date, image, colour FROM latest_news ORDER BY date DESC LIMIT 3"; /* Gathers data stored within selected Columns & selected Table */
